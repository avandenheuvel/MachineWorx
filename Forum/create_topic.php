		...
		else
		{
			...
			else
			{
				...
				if(!$result)
				{
					...
					echo 'An error2 occured while inserting your data. Please try again later.<br /><br />' . mysql_error();
					$sql = "ROLLBACK;";
					$result = mysql_query($sql);
				}
				else
				{
					...
					{
						//something went wrong, display the error
						echo 'An error3 occured while inserting your post. Please try again later.<br /><br />' . mysql_error();
						$sql = "ROLLBACK;";
						$result = mysql_query($sql);
					}
					else
